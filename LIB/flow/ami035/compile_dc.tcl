...
#/**************************************************/
set OSUcells [format "%s%s"  [getenv "OSUcells"] "/lib/ami035/lib"]
set search_path [concat  $search_path $OSUcells]
set alib_library_analysis_path $OSUcells

set link_library [set target_library [concat  [list osu035_stdcells.db] [list dw_foundation.sldb]]]
set target_library "osu035_stdcells.db"
